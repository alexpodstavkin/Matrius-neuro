...
const HERO_IMAGE = 'hero-lesson-en.jpg';

export default function Hero({ onCTA }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 items-stretch">
      <Reveal className="col-span-1 md:col-span-12 lg:col-span-7" delay={0.05}>
        <div className="shell h-full">
          <div className="dark-inner h-full rounded-[26px] bg-navy text-white p-5 md:p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden">
            ...
            <h1
              className="relative font-bold text-white leading-[1.1] tracking-[-0.02em] mb-6 md:mb-7"
              style={{ fontSize: 'clamp(1.75rem, 0.75rem + 2.1vw, 3.25rem)' }}
            >
              Ребёнок учит английский, но&nbsp;не&nbsp;может сказать даже одно предложение? Найдём причину и&nbsp;<span className="text-orange">решим её&nbsp;— за&nbsp;60&nbsp;минут</span> на&nbsp;бесплатной диагностике.
            </h1>
      ...
      <Reveal className="hidden lg:block lg:col-span-5" delay={0.15}>
        <div className="shell h-full">
          <div className="relative h-full overflow-hidden rounded-[26px] bg-navy-light">
            <img
              src={HERO_IMAGE}
              alt="Ребёнок 7–10 лет на онлайн-уроке английского с педагогом Matrius"
