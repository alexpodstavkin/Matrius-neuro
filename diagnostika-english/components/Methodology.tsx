...
const PRINCIPLES = [
  {
    ...
    desc: 'Сложные конструкции из&nbsp;учебника заменяем на&nbsp;язык, который ребёнок понимает. Так он&nbsp;понимает грамматику и&nbsp;может применить знания на&nbsp;практике.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Учим через то, что нравится ребёнку. Запоминается быстрее, потому что не&nbsp;«надо», а&nbsp;«интересно».',
  },
  {
        ...
        <Reveal>
          <div className="shell">
            <article className="card-flush p-5 md:p-12 lg:p-16">
              <div className="max-w-4xl mb-6 md:mb-14">
                <h2 className="h2">
                  Обучаем по&nbsp;уникальной методике Matrius. <span className="text-orange">Ребёнок начинает говорить с&nbsp;первого занятия</span>
                </h2>
              </div>
