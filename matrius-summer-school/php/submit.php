<?php
/**
 * Обработчик формы лендинга /matrius-summer-school/.
 ...
 *      По умолчанию URL обработчика будет: /matrius-summer-school/php/submit.php
 *   3. На фронте NEXT_PUBLIC_LEAD_ENDPOINT = /matrius-summer-school/php/submit.php
 *      (или абсолютный URL).
 *
 * Безопасность:
