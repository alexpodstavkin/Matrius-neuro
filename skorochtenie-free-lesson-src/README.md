...
## Таймер
Отсчёт до ближайших 12:00 или 00:00 по времени посетителя — всегда не больше 12 часов, формат ЧЧ:ММ:СС без дней. Считается в браузере (`components/Countdown.tsx`).
