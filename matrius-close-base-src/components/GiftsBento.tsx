...
const GIFTS: Gift[] = [
  {
    ...
    desc: 'Ребёнок снизит количество глупых ошибок и сделает почерк аккуратным за 3 недели.',
  },
  {
  ...
  {
    title: 'Гайд полезных привычек',
    desc: 'Простые инструкции, как помочь ребёнку в организации дня, чтобы и погулять, и поиграть, и выполнить ДЗ без участия родителя.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Игровой комплекс: ребёнок научится удерживать внимание на уроке весь академический час.',
  },
];
