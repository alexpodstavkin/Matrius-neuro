  ...
  return (
    <section className="relative">
      <div className="container-x section">
        <article className="relative overflow-hidden rounded-xl bg-navy text-white">
          <div
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 items-stretch">
            ...
            <div className="p-6 md:p-10 lg:p-14 flex flex-col justify-center">
              <div className="inline-flex self-start items-center gap-2 rounded-md bg-orange px-3 py-1.5 text-[12px] font-bold uppercase tracking-wide mb-5">
                Бонус
              </div>
              <h2
                className="font-bold text-white leading-tight mb-5"
                style={{ fontSize: 'clamp(1.625rem, 3vw, 2.5rem)', letterSpacing: '-0.005em' }}
              >
              ...
              <div className="rounded-xl bg-white/10 backdrop-blur border border-white/15 p-4 md:p-5 mb-7">
