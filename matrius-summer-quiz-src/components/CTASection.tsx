      ...
      <div className="container-x section">
        <article className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 items-stretch">
          <div className="md:col-span-7 lg:col-span-7">
            <div className="h-full rounded-xl bg-navy text-white p-6 md:p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden">
              <div
                className="pointer-events-none absolute -right-32 -top-32 h-80 w-80 rounded-full bg-orange/20 blur-3xl"
                aria-hidden
              />
              <h2
                className="relative font-bold text-white leading-tight mb-5"
                style={{ fontSize: 'clamp(1.875rem, 3.6vw, 3rem)', letterSpacing: '-0.01em' }}
              >
              ...
              <p className="relative text-white/85 text-base md:text-lg leading-relaxed mb-7 max-w-2xl">
