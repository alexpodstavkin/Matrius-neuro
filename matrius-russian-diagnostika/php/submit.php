 ...
 * Принимает JSON от Next.js-формы и создаёт сделку в GetCourse через
 ...
 *      По умолчанию URL обработчика будет: /matrius-russian-diagnostika/php/submit.php
 *   3. На фронте NEXT_PUBLIC_LEAD_ENDPOINT = /matrius-russian-diagnostika/php/submit.php
 *      (или абсолютный URL).
 *
 * Безопасность:
...
// 6. Сборка GC payload
// ─────────────────────────────────────────────────────────────────────
// Оффер захардкожен — у нас один .env на все лендинги, и GC_OFFER_CODE
// там стоит от другого лендинга. Если когда-нибудь понадобится
// переопределить — лучше через имя файла обработчика, чем через общий env.
